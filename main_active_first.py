    ...
    for metric in ["bmax"]:  #"bvsb", "ep", "bmax", "bavg"
        ...
        for i in range(0, 3):
            ...
            checkpointer = ModelCheckpoint(
                filepath="models_active/first/" + metric + "/cnn_active_" + str(i + 1) + "_first_" + str(j) + "_best.hdf5",
            ...
            cnn = load_model("models_active/first/" + metric + "/cnn_active_" + str(i + 1) + "_first_" + str(j) + "_best.hdf5")
            loss, acc = cnn.evaluate(x_valid, y_valid, verbose=1)

            with open('models_active/first/active_' + metric + '_results_' + str(j) + '_best.txt', 'a') as f:
