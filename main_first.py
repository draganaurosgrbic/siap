...
def train_cnn():
    ...
    checkpointer = ModelCheckpoint(filepath="cnn_best_first.hdf5", verbose=1, save_best_only=True)
    ...
    cnn.save("cnn_first.hdf5")


if __name__ == '__main__':
    # train_cnn()
    # exit(0)
    clf_cnn = load_model("models_active/first/cnn_active_3_first_1_best.hdf5")
    ...
    for img_name in os.listdir("test"):
        ...
        cv2.imwrite('output/cnn/active/first/' + img_name.split('.')[0] + '.png', itest)
