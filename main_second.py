...
def train_cnn():
    ...
    checkpointer = ModelCheckpoint(filepath="cnn_best_second.hdf5", verbose=1, save_best_only=True)
    ...
    cnn.save("cnn_second.hdf5")


if __name__ == '__main__':
    # train_cnn()
    # exit(0)
    clf_cnn = load_model("models_active/second/cnn_active_3_second_0_best.hdf5")
    ...
    for img_name in os.listdir("test"):
        ...
        cv2.imwrite('output/cnn/active/second/' + img_name.split('.')[0] + '.png', itest)
